...
function minus1(){
  ...
  document.getElementById('pic_nizerte').style=`background-image: url(${bizerte[x]})`
}
  ...
  return(
    <>
      <div className="event">
        ...
        <div className="choufli">
          <div className="scroll">
            <img src={left_arrow} className='icon left' onClick={() => minus()}/>
            <div id='pic_choufli' style={{  backgroundImage: `url(${image0})`}}></div>
            <img src={right_arrow} className='icon right' onClick={() => plus()}/>
          </div>
          <div className="text">
            <h2>Choufli Code</h2>
      ...
      <div className="Bizerte">
        ...
        <div className="scroll">
          <img src={left_arrow} className='icon right1' onClick={() => minus1()} />
          <div id='pic_bizerte' style={{  backgroundImage: `url(${imagea})`}}></div>
          <img src={right_arrow} className='icon left1' onClick={() => plus1()}/>
        </div>
      </div>
    </>
  )
